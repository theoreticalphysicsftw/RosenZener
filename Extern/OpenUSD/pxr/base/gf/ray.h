...
/// direction.
///
/// Note that by default a \c Ray does not normalize its direction
...
class Ray {
  ...
  public:
    ...
    Vec3d             GetPoint(double distance) const {
    ...
    GF_API
    Vec3d             FindClosestPoint(const Vec3d &point,
    ...
    /// \endcode
    GF_API
    bool    Intersect(const Vec3d &p0,
                      const Vec3d &p1,
                      const Vec3d &p2,
                      double *distance = NULL,
                      Vec3d *barycentricCoords = NULL,
    ...
    /// normal points.
    GF_API
    bool	Intersect(const Plane &plane, double *distance = NULL,
    ...
    GF_API
    bool        Intersect(const Range3d &box,
    ...
    /// points in \p enterDistance and \p exitDistance.
    GF_API
    bool        Intersect(const BBox3d &box,
                          double *enterDistance = NULL,
                          double *exitDistance = NULL) const;
    ...
    GF_API
    bool        Intersect(const Vec3d &center, double radius,
                          double *enterDistance = NULL,
                          double *exitDistance = NULL ) const;
    ...
    GF_API
    bool Intersect(const Vec3d &origin,
                   const Vec3d &axis,
                   const double  radius,
                   double        *enterDistance = NULL,
                   double        *exitDistance = NULL) const;
  ...
  private:
    GF_API
    friend bool FindClosestPoints( const Ray &, const Line &,
                                     Vec3d *, Vec3d *,
                                     double *, double * );
    GF_API
    friend bool FindClosestPoints( const Ray &, const LineSeg &,
                                     Vec3d *, Vec3d *,
                                     double *, double * );
...
/// undefined.
GF_API
bool FindClosestPoints( const Ray &ray, const Line &line,
                          Vec3d *rayPoint = nullptr,
                          Vec3d *linePoint = nullptr,
...
/// undefined.
GF_API
bool FindClosestPoints( const Ray &ray, const LineSeg &seg,
                          Vec3d *rayPoint = nullptr,
                          Vec3d *segPoint = nullptr,
                          double *rayDistance = nullptr,
                          double *segDistance = nullptr );

/// Output a Ray using the format [(x y z) >> (x y z)].
/// \ingroup group_gf_DebuggingOutput
GF_API std::ostream& operator<<(std::ostream&, const Ray&);

...
Quath::Quath(Quatd const &other)
    : _imaginary(other.GetImaginary())
    , _real(other.GetReal())
{
}
Quath::Quath(Quatf const &other)
    : _imaginary(other.GetImaginary())
    , _real(other.GetReal())
{
}
...
std::ostream& 
operator<<(std::ostream &out, Quath const &q)
{
    Vec3h i = q.GetImaginary();
    Half real = q.GetReal();
    return out << Vec4h(real, i[0], i[1], i[2]);
}

Half
Quath::Normalize(Half eps)
{
...
//
//     (Q * Quath(0, P) * Q.GetInverse()).GetImaginary()
...
//
Vec3h
Quath::Transform(const Vec3h& point) const
{
    Half tmpDot = Dot(_imaginary, _imaginary);
    Half tmpSqr = _real * _real;
...
Quath::operator *=(const Quath &q)
{
    Half r1 = GetReal();
    Half r2 = q.GetReal();
    const Vec3h &i1 = GetImaginary();
    const Vec3h &i2 = q.GetImaginary();

    Half r = r1 * r2 - Dot(i1, i2);
